...
public class CreateOrderTest extends BaseTest {
	...
	public Iterator<String[]> data() throws IOException {
		...
		return createOrder.getTestSuiteDataProvider(getProperty("testDataPath"), SPLIT_BY_CSV, "", "9509");
	}
	...
	@Features({"BAT"})
	@TestCaseId("9509")
	@Test(dataProvider = "test", groups = {"Regression", "Bat", "Smoke"}, enabled = true)
