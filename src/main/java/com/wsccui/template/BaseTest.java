...
import static core.GlobalConstatnt.CHARS_NOT_ALLOWED;
...
import static core.util.wsccui.WebDriverFactory.createDriver;
...
import static core.util.BaseConfig.createSterlingJdbcDriver;
import static core.util.BaseConfig.createTibcoJdbcDriver;
...
public class BaseTest implements ITest {
	...
	public void liteReport() throws SQLException {
		...
		wResultFile(getFailOrders(), "./target/wsccui-out-csv/", "fail/", nameFileFail);
